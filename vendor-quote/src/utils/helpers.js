...
export const STATUS_CONFIG = {
  ...
  submitted: { label: 'Submitted', bg: 'bg-yellow-50', text: 'text-yellow-700', border: 'border-yellow-200' },
  pending_approval: { label: 'Pending Approval', bg: 'bg-yellow-50', text: 'text-yellow-700', border: 'border-yellow-200' },
  returned_for_editing: { label: 'Returned', bg: 'bg-blue-50', text: 'text-blue-600', border: 'border-blue-200' },
  resubmitted: { label: 'Resubmitted', bg: 'bg-amber-50', text: 'text-amber-700', border: 'border-amber-300' },
  approved: { label: 'Approved', bg: 'bg-green-50', text: 'text-green-700', border: 'border-green-200' },
  declined: { label: 'Declined', bg: 'bg-red-50', text: 'text-red-600', border: 'border-red-200' },
  ...
  blocked: { label: 'Blacklisted', bg: 'bg-orange-50', text: 'text-orange-700', border: 'border-orange-200' },
  blacklisted: { label: 'Blacklisted', bg: 'bg-orange-50', text: 'text-orange-700', border: 'border-orange-200' },
  completed: { label: 'Completed', bg: 'bg-blue-50', text: 'text-blue-600', border: 'border-blue-200' },
  on_hold: { label: 'On Hold', bg: 'bg-yellow-50', text: 'text-yellow-600', border: 'border-yellow-200' },
};
