...
<h1 className="text-[calc(100%+12px)]">
  ...
  <span className="block">Breakdown</span>
    ...
    <div class="footer">Generated by Rippotai ERP</div>
  </div>
    ...
    return `
      <div class="summary-box">
        ...
        ${extras
          ...
          .join('')}
        <div class="summary-line"><span>Miscellaneous (${this.formatValue(boq.misc_pct)}%)</span><span>${this.formatCurrency(boq.misc_amount)}</span></div>
