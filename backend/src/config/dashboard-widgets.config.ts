...
export const DASHBOARD_CONFIG: Record<string, AppDashboardConfig> = {
  ...
  materials: {
    widgets: [
      {
        key: 'materials.total_materials',
        name: 'Total Materials',
        description: 'Count of all materials, with total stock units',
        category: 'App Data',
        sizes: ['small'],
        defaultSize: 'small',
        locked_required: true,
      ...
      {
        key: 'materials.pending_requests',
      ...
      {
        key: 'materials.active_purchase_orders',
      ...
      {
        key: 'materials.purchase_orders_list',
      ...
      {
        key: 'materials.recent_movements',
    ...
    defaultLayout: [
      { key: 'materials.total_materials', x: 0, y: 0, w: 3, h: 2 },
      { key: 'materials.low_stock', x: 3, y: 0, w: 3, h: 2 },
      { key: 'materials.pending_requests', x: 6, y: 0, w: 3, h: 2 },
      { key: 'materials.active_purchase_orders', x: 9, y: 0, w: 3, h: 2 },
      { key: 'materials.category_wise', x: 0, y: 2, w: 6, h: 4 },
      { key: 'materials.low_stock_list', x: 6, y: 2, w: 6, h: 4 },
      { key: 'materials.requests_list', x: 0, y: 6, w: 6, h: 3 },
      { key: 'materials.recent_activity', x: 6, y: 6, w: 6, h: 3 },
    ],
    requiredKeys: ['materials.total_materials'],
  },
  ...
  admin: {
    ...
    defaultLayout: [
      { key: 'admin.active_projects', x: 0, y: 0, w: 3, h: 2 },
      { key: 'admin.open_leads', x: 3, y: 0, w: 3, h: 2 },
      { key: 'admin.pending_approvals', x: 6, y: 0, w: 3, h: 2 },
      { key: 'admin.team_members', x: 9, y: 0, w: 3, h: 2 },
      { key: 'admin.projects_list', x: 0, y: 2, w: 6, h: 4 },
      { key: 'admin.lead_pipeline', x: 6, y: 2, w: 6, h: 4 },
      { key: 'admin.approvals_list', x: 0, y: 6, w: 6, h: 3 },
      { key: 'admin.recent_activity', x: 6, y: 6, w: 6, h: 3 },
      { key: 'admin.workflow_snapshot', x: 0, y: 9, w: 12, h: 3 },
    ],
    requiredKeys: ['admin.active_projects'],
  },
